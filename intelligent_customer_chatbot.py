...
- "how are you?" -> "Hi! I'm doing great, thanks for asking 😊 How can I assist you today?"
- "thank you" -> "You're welcome! Happy to help 😊"
- "I can't log in" -> "I understand your frustration 💙 To reset your password, go to settings and click 'Forgot Password'."
...
def push_to_crm(user_text, bot_response):
    ...
    print("Conversation saved to local CRM ✅")
...
print("Bot: Hello 👋 I'm here to help you. Type 'exit' to quit.\n")

while True:
    user_message = input("Customer: ").strip()

    if user_message.lower() in ["exit", "quit", "bye"]:
        print("Bot: Thank you for contacting support. Take care! 👋")
        break
